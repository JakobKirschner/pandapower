...
- [ADDED] add function to determine qmin and qmax based on active power dispatch in build_gen and update the dataframe with the determined values
- [ADDED] add three columns: id_q_capability_curve_characteristic, reactive_capability_curve, curve_style in gen and sgen
